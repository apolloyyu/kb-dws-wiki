---
source_path: "skills/mono/references/products/ding.md"
...
完成根 Skill 前置要求后，本页是 DING 唯一默认 Reference。已知路径直接执行；仅在
...
| 普通聊天、建群、群消息和解散群 | [chat.md](./chat.md) | Chat 拥有群资源，DING 只负责强提醒 |
