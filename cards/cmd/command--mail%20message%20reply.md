...
kind: command
completeness: full
usage: dws mail message reply
description: 回复邮件
example: dws mail message reply --from user@company.com --id <messageId> --subject "Re: 周报" --content "已收到，谢谢！"
source: internal/helpers/mail.go:1354
visible_flags: 7
